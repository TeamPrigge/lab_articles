...
[frac_abs,frac_trans,params,r,depth]=MonteCarloLight(1,.1,.5,635 ...
    ,100);
%[frac_abs,frac_trans,params,r,depth]=MonteCarloLight(3,.031,.55,[2 2 1] );
figure; LightHeatPlotter(r,depth,log10(frac_trans./max(frac_trans(:))),635);caxis([-4 0])
